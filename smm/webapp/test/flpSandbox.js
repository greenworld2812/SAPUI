		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Order Details",
									"targetURL": "#smmpurchasesmm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smmpurchasesmm-display": {
								"semanticObject": "smmpurchasesmm",
								"action": "display",
								"description": "Northwind Order details",
								"title": "Order Details",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smm.purchase.smm",
									"url": sap.ui.require.toUrl("smm/purchase/smm")
								}
							}
						}
					}
